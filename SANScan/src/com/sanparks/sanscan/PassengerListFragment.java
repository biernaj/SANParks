...
public class PassengerListFragment extends ListFragment {
	 ...
	 * represents.
	 */
	public static final String ARG_ITEM_ID = "passenger_id";
	/**
...
//			setListAdapter(new ArrayAdapter<ArrayList<Map<String,Object>>>(getActivity(),
//					R.layout.fragment_check_detail_passenger,
//					android.R.id.text1, recArray));
	...
	public void onListItemClick(ListView listView, View view, int position, long id) 
	{
		...
		mCallbacks.onItemSelected(ContentEntry.ITEMS.get(position).id);
	}
